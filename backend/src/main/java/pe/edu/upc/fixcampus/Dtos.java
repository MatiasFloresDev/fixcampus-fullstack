...
public final class Dtos {
    ...
    public record SuggestionInput(@NotBlank @Size(max=5000) String description) { }
    public record Suggestion(String source, String title, String summary, Long categoryId, Priority priority, String explanation) { }
